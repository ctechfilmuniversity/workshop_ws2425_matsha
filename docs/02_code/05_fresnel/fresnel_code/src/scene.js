...
import vertexShader from './shader/fresnel.vert';
import fragmentShader from './shader/fresnel.frag';
...
function generateMaterials() {
    ...
    const materials = {
        ...
        // 'MeshPhongMaterial': new THREE.MeshPhongMaterial({color: 0x049ef4, shininess: 100, specular: 0x565600}),
...
sphereShader.position.set(0,0,0);
...
torusKnotShader.position.set(12,0,0);
...
cubeShader.position.set(-13,0,0);
